...
\newcommand{\dyad}[1]{#1}%{\overline{\overline{#1}}}
\renewcommand{\div}{\nabla \cdot }
...
\hypersetup{ 
	...
	pdfsubject = {Finite Element Analysis in Electromagnetics, Domain Decomposition Methods, Harmonic Balance Finite Elements},
...
%\setbeamertemplate{sidebar right}{\usebeamertemplate{navigation symbols}}
